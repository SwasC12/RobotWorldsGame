...
//            String launchRobot = userInput.readLine();
            ...
            if (getInput("Do you want to launch a robot? (yes/no): ").equalsIgnoreCase("yes")) {
...
//                        System.out.println(createJSONObject.getRobotName() + "> What must I do next?");
                        String command = getInput(createJSONObject.getRobotName() + "> What must I do next?").strip().toLowerCase();
